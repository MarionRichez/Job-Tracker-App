(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["components-home-home-module"], {
    ...
    function srcAppComponentsHomeHomePageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var src_app_service_application_service_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      ...
      var HomePage = /*#__PURE__*/function () {
        function HomePage(applicationService, authService) {
        ...
        _createClass(HomePage, [{
          ...
          value: function getApplications() {
            ...
            this.applicationService.getAllApplication().subscribe(function (data) {
          ...
          key: "getByStatus",
          value: function getByStatus(selectValue) {
            var _this2 = this;

            if (selectValue == "all") {
              this.getApplications();
            } else {
              this.applicationService.getApplicationByStatus(selectValue).subscribe(function (data) {
                _this2.applications = data;
              });
            }
