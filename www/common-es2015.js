...
let ApplicationService = class ApplicationService {
    constructor(authService, firestore, navCtrl) {
    ...
    addApplication(data) {
        this.getPath()
            .add(data)
            .then(() => { console.log("Application has been created"); }, () => { console.log("Application was wrongly created"); });
    ...
    updateApplication(id, data) {
        this.getPath()
            .doc(id)
            .set(data)
            .then(() => { console.log("Application has been updated"); }, () => { console.log("Application was wrongly updated"); });
...
let AuthService = class AuthService {
    constructor(authFirebase, firestore, route) {
    ...
    signIn(email, password) {
        this.authFirebase
            ...
            .catch((err) => console.log(`SignIn : ${err.message}`));
    }
...
let InterviewService = class InterviewService {
    ...
    getAllInterviews(applicationId) {
        return this.getPath()
            .doc(applicationId)
            .collection(this.interview)
            .snapshotChanges();
    }
    getInterviewsById(applicationId, interviewId) {
        return this.getPath()
            .doc(applicationId)
            .collection(this.interview)
            .doc(interviewId)
    ...
    addInterview(applicationId, data) {
        this.getPath()
            ...
            .collection(this.interview)
            .add(data)
            .then(() => { console.log("Interview has been created"); }, () => { console.log("Interview was wrongly created"); });
    ...
    updateInterview(applicationId, interviewId, data) {
        this.getPath()
            ...
            .doc(interviewId)
            .set(data)
            .then(() => { console.log("Interview has been updated"); }, () => { console.log("Interview was wrongly updated"); });
        this.navCtrl.navigateRoot(`application/${applicationId}`);
    }
...
InterviewService.ctorParameters = () => [
    { type: _auth_service_service__WEBPACK_IMPORTED_MODULE_4__["AuthService"] },
    { type: _angular_fire_firestore__WEBPACK_IMPORTED_MODULE_2__["AngularFirestore"] },
    { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["NavController"] }
];
InterviewService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
    })
], InterviewService);
